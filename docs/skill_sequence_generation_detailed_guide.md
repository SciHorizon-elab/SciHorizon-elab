...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/benchmark/tasks/dm_task.py`
...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/benchmark/tasks/autogen_tasks/primitive/select_poker_series.py`
...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/benchmark/tasks/autogen_tasks/primitive/add_condiment_series.py`
...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/benchmark/tasks/autogen_tasks/composite/base.py`
...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/utils/skill_lib.py`
...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/pipeline/tools/trajectory_generation.py`
...
**文件位置**：`/ssd/qinmaokai/workspace/SciHorizon-ELAB/scihorizon_elab/envs/dm_env.py`
...
| 文件路径 | 功能 | 关键内容 |
|---------|------|---------|
| `scihorizon_elab/benchmark/tasks/dm_task.py` | 任务基类 | `get_expert_skill_sequence()` 基类定义 |
| `scihorizon_elab/benchmark/tasks/autogen_tasks/primitive/*.py` | 原始任务定义 | 各任务的专家技能序列实现 |
| `scihorizon_elab/benchmark/tasks/autogen_tasks/composite/*.py` | 复合任务定义 | 复杂任务的技能序列生成逻辑 |
| `scihorizon_elab/utils/skill_lib.py` | 技能库 | 所有可用技能的实现 |
| `scihorizon_elab/envs/dm_env.py` | Mujoco环境包装 | 环境接口和执行逻辑 |
...
| 文件路径 | 功能 |
|---------|------|
| `scihorizon_elab/configs/evaluation/dim2task.json` | 评测维度到任务的映射 |
| `scihorizon_elab/configs/tasks/*.json` | 任务配置参数 |
...
**文件**：`scihorizon_elab/benchmark/tasks/autogen_tasks/primitive/sort_fruit_series.py`

```python
from functools import partial
import numpy as np
from scihorizon_elab.tasks.dm_task import DMTask
...
**评测脚本**：`scihorizon_elab/evaluation/evaluator/vlm.py`
...
**评分维度**（详见 `scihorizon_elab/evaluation/utils.py`）：
...
- GitHub：https://github.com/OpenMOSS/scihorizon_elab
- 数据集：https://huggingface.co/datasets/scihorizon_elab/vlm_evaluation_v1.0

---

**文档版本**：v1.0
**最后更新**：2026-03-10
**作者**：scihorizon_elab Team
