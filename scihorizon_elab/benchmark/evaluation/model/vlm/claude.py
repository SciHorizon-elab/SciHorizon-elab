from scihorizon_elab.benchmark.evaluation.model.vlm.base import *

class Claude(BaseVLM):
    def __init__(self, api_key=None, base_url=None, model="claude-3-7-sonnet-20250219") -> None:
    ...
    def evaluate(self, input_dict, language, with_CoT=False):
        from scihorizon_elab.utils.gpt_utils import build_prompt_with_tilist, query_gpt4_v
        ti_list = []
