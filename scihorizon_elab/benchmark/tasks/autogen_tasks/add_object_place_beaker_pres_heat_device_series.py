...
@register.add_config_manager("add_object_place_beaker_pres_heat_device")
class AddObjectPlaceBeakerPresHeatDeviceConfigManager(BenchTaskConfigManager):
...
@register.add_task("add_object_place_beaker_pres_heat_device")
class AddObjectPlaceBeakerPresHeatDeviceTask(PrimitiveTask):
