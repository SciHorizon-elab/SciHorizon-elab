...
@register.add_config_manager("custom_tube_lift")
class CustomTubeLiftConfigManager(BenchTaskConfigManager):
...
@register.add_task("custom_tube_lift")
class CustomTubeLiftTask(PrimitiveTask):
