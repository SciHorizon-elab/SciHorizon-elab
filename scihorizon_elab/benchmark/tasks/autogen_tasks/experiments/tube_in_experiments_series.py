...
@register.add_config_manager("tube_in_experiments")
class TubeInExperimentsConfigManager(BenchTaskConfigManager):
...
@register.add_task("tube_in_experiments")
class TubeInExperimentsTask(PrimitiveTask):
