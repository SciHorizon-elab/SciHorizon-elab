...
@register.add_config_manager("tube_in_experiments_v2")
class TubeInExperimentsV2ConfigManager(BenchTaskConfigManager):
...
@register.add_task("tube_in_experiments_v2")
class TubeInExperimentsV2Task(PrimitiveTask):
