...
class LiftBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            name="small_beaker_2",
            xml_path=name2class_xml["small_beaker"][-1],
            position=[random.uniform(0.0, 0.15), random.uniform(-0.05, 0.1), 0.8],
            solution="solution_3",
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Lift the <small_beaker_0> containing the red <solution_0>."]
