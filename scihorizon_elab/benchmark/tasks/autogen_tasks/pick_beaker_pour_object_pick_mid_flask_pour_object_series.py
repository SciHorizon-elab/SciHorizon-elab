...
@register.add_config_manager("pick_beaker_pour_object_pick_mid_flask_pour_object")
class PickBeakerPourObjectPickMidFlaskPourObjectConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            name="conical_flask_mid_0",
            xml_path=name2class_xml["conical_flask_mid"][-1],
    ...
    def get_condition_config(self, target_entity, **kwargs):
        conditions_config = [
            ...
            receiver_container='conical_flask_mid_0',
            robot='robot',
        )),
            dict(is_grasped=dict(entities=['conical_flask_mid_0'], robot='robot')),
            dict(pour_into=dict(
            target_entity='conical_flask_mid_0',
...
@register.add_task("pick_beaker_pour_object_pick_mid_flask_pour_object")
class PickBeakerPourObjectPickMidFlaskPourObjectTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.pour_to_entity, target_container_name="conical_flask_mid_0", tilt_angle=1.8, wait_time=10),
            partial(SkillLib.drop),
            partial(SkillLib.pick, target_entity_name="conical_flask_mid_0"),
