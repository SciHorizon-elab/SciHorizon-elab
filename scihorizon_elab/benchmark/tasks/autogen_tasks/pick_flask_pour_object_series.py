...
@register.add_config_manager("pick_flask_pour_object")
class PickFlaskPourObjectConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick the <flask_0> which contains <CuSO4 solution_0>."]
...
@register.add_task("pick_flask_pour_object")
class PickFlaskPourObjectTask(PrimitiveTask):
