...
@register.add_config_manager("pick_mechanical_pipette")
class PickMechanicalPipetteConfigManager(BenchTaskConfigManager):
...
@register.add_task("pick_mechanical_pipette")
class PickMechanicalPipetteTask(PrimitiveTask):
