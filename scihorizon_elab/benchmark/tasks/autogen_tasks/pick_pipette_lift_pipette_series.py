...
@register.add_config_manager("pick_pipette_lift_pipette")
class PickPipetteLiftPipetteConfigManager(BenchTaskConfigManager):
    ...
    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            ...
            dict(lift=dict(entities=['pipette_0'], lift_height=0.15)),
        ]
        self.config["task"]["conditions"] = conditions_config


@register.add_task("pick_pipette_lift_pipette")
class PickPipetteLiftPipetteTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            # partial(SkillLib.gently_pick, target_entity_name="pipette_0"),
