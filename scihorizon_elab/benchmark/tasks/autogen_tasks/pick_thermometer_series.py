...
@register.add_config_manager("pick_thermometer")
class PickThermometerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick the <thermometer_0>."]
...
@register.add_task("pick_thermometer")
class PickThermometerTask(PrimitiveTask):
