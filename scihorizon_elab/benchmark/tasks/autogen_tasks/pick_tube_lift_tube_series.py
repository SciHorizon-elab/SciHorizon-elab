...
@register.add_config_manager("pick_tube_lift_tube")
class PickTubeLiftTubeConfigManager(BenchTaskConfigManager):
...
@register.add_task("pick_tube_lift_tube")
class PickTubeLiftTubeTask(PrimitiveTask):
