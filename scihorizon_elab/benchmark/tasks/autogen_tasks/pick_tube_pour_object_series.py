...
@register.add_config_manager("pick_tube_pour_object")
class PickTubePourObjectConfigManager(BenchTaskConfigManager):
...
@register.add_task("pick_tube_pour_object")
class PickTubePourObjectTask(PrimitiveTask):
