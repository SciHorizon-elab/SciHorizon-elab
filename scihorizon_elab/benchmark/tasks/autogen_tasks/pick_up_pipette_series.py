...
@register.add_config_manager("pick_up_pipette")
class PickUpPipetteConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <pipette_0>."]
...
@register.add_task("pick_up_pipette")
class PickUpPipetteTask(PrimitiveTask):
