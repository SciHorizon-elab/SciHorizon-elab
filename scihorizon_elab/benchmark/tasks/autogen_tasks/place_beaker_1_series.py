...
@register.add_config_manager("place_beaker_1")
class PlaceBeaker1ConfigManager(BenchTaskConfigManager):
...
@register.add_task("place_beaker_1")
class PlaceBeaker1Task(PrimitiveTask):
