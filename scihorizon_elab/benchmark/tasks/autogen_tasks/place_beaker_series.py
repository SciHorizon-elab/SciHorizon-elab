...
@register.add_config_manager("place_beaker")
class PlaceBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["place small_beaker_0 on the heat_device_0"]
...
@register.add_task("place_beaker")
class PlaceBeakerTask(PrimitiveTask):
