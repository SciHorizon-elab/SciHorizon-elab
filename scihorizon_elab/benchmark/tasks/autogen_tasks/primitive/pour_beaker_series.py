...
@register.add_config_manager("pour_beaker")
class PourBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour <CSO4 solution_0> from the <small_beaker_0> into the <large_beaker_0>."]
...
@register.add_task("pour_beaker")
class PourBeakerTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.pour_to_entity, target_container_name="large_beaker_0", tilt_angle=2, wait_time=10),
