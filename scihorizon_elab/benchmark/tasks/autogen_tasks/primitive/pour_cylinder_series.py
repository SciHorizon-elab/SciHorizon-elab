...
@register.add_config_manager("pour_cylinder")
class PourCylinderConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour the CuSO4 solution from cylinder_mid_0 into large_beaker_0."]
...
@register.add_task("pour_cylinder")
class PourCylinderTask(PrimitiveTask):
