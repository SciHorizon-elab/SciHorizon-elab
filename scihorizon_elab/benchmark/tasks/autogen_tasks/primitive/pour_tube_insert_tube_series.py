...
@register.add_config_manager("pour_tube_insert_tube")
class PourTubeInsertTubeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["pick the <tube_0> which contains <CuSO4_0> and pour <CuSO4_0> form <tube_0> into <large_beaker_0>."]
...
@register.add_task("pour_tube_insert_tube")
class PourTubeInsertTubeTask(PrimitiveTask):
