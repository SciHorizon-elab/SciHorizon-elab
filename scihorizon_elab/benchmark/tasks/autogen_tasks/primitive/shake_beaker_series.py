...
@register.add_config_manager("shake_beaker")
class ShakeBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.15, 0.15), random.uniform(-0.15, 0.05), 0.8],
        )
...
@register.add_task("shake_beaker")
class ShakeBeakerTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.shake, n_shakes=3),
