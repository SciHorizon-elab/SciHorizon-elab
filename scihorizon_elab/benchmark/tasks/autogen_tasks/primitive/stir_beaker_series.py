...
@register.add_config_manager("stir_beaker")
class StirBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["stir the <large_beaker_0> which contains <CuSO4_0> with <glass_stirring_rod_0>"]
...
@register.add_task("stir_beaker")
class StirBeakerTask(PrimitiveTask):
