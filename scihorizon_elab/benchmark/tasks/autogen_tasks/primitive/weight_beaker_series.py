...
@register.add_config_manager("weight_beaker")
class WeightBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["pick the <small_beaker_0> and place it on the <electronic_scale_0>"]
...
@register.add_task("weight_beaker")
class WeightBeakerTask(PrimitiveTask):
