...
@register.add_config_manager("weight_flask")
class WeightFlaskConfigManager(BenchTaskConfigManager):
...
@register.add_task("weight_flask")
class WeightFlaskTask(PrimitiveTask):
