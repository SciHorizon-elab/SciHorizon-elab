...
@register.add_config_manager("wait_beaker_place_beaker_pres_heat_device")
class WaitBeakerPlaceBeakerPresHeatDeviceConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["wait <small_beaker_0> add <CuSO4 solution_0>."]
...
@register.add_task("wait_beaker_place_beaker_pres_heat_device")
class WaitBeakerPlaceBeakerPresHeatDeviceTask(PrimitiveTask):
