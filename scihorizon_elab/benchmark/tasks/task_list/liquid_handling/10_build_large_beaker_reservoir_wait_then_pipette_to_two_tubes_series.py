...
@register.add_config_manager("10_build_large_beaker_reservoir_wait_then_pipette_to_two_tubes")
class Task10BuildLargeBeakerReservoirWaitThenPipetteToTwoTubesConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(0.0150, 0.1520), random.uniform(0.1050, 0.2420), 0.8],
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <flask_0> containing <KMnO4 solution_0>."]
...
@register.add_task("10_build_large_beaker_reservoir_wait_then_pipette_to_two_tubes")
class Task10BuildLargeBeakerReservoirWaitThenPipetteToTwoTubesTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.wait_for, wait_duration=2.0, entity_name="large_beaker_0", change_type="add_solution", solution="CuSO4"),
