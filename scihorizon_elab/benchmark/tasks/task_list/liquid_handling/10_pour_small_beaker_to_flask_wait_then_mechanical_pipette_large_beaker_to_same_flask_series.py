...
@register.add_config_manager("10_pour_small_beaker_to_flask_wait_then_mechanical_pipette_large_beaker_to_same_flask")
class Task10PourSmallBeakerToFlaskWaitThenMechanicalPipetteLargeBeakerToSameFlaskConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <small_beaker_0> containing <CuSO4 solution_0>."]
...
@register.add_task("10_pour_small_beaker_to_flask_wait_then_mechanical_pipette_large_beaker_to_same_flask")
class Task10PourSmallBeakerToFlaskWaitThenMechanicalPipetteLargeBeakerToSameFlaskTask(PrimitiveTask):
