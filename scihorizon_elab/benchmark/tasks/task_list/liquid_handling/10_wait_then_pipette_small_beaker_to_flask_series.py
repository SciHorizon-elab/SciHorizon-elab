...
@register.add_config_manager("10_wait_then_pipette_small_beaker_to_flask")
class Task10WaitThenPipetteSmallBeakerToFlaskConfigManager(BenchTaskConfigManager):
...
@register.add_task("10_wait_then_pipette_small_beaker_to_flask")
class Task10WaitThenPipetteSmallBeakerToFlaskTask(PrimitiveTask):
