...
@register.add_config_manager("10_wait_then_pour_small_beaker_to_flask")
class Task10WaitThenPourSmallBeakerToFlaskConfigManager(BenchTaskConfigManager):
...
@register.add_task("10_wait_then_pour_small_beaker_to_flask")
class Task10WaitThenPourSmallBeakerToFlaskTask(PrimitiveTask):
