...
@register.add_config_manager("11_parallel_mechanical_pipette_small_beaker_to_tube_then_pour_flask_to_medium_cylinder")
class Task11ParallelMechanicalPipetteSmallBeakerToTubeThenPourFlaskToMediumCylinderConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.3300, -0.1930), random.uniform(0.0565, 0.1935), 0.8],
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["First, use the <mechanical_pipette_0> to aspirate <FeCl2 solution_0> from the <small_beaker_0>."]
...
@register.add_task("11_parallel_mechanical_pipette_small_beaker_to_tube_then_pour_flask_to_medium_cylinder")
class Task11ParallelMechanicalPipetteSmallBeakerToTubeThenPourFlaskToMediumCylinderTask(PrimitiveTask):
