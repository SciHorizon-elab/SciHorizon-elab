...
@register.add_config_manager("11_parallel_pipette_small_beaker_to_flask_then_mechanical_pipette_large_beaker_to_tube")
class Task11ParallelPipetteSmallBeakerToFlaskThenMechanicalPipetteLargeBeakerToTubeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.1960, 0.3270), random.uniform(-0.0910, 0.0340), 0.8],
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["First, use the <pipette_0> to aspirate <CuSO4 solution_0> from the <small_beaker_0>."]

    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            dict(aspirate=dict(source_container='small_beaker_0', tool='pipette_0', robot='robot')),
...
@register.add_task("11_parallel_pipette_small_beaker_to_flask_then_mechanical_pipette_large_beaker_to_tube")
class Task11ParallelPipetteSmallBeakerToFlaskThenMechanicalPipetteLargeBeakerToTubeTask(PrimitiveTask):
