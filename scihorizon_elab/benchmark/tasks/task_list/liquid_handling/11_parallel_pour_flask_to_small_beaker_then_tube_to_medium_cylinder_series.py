...
@register.add_config_manager("11_parallel_pour_flask_to_small_beaker_then_tube_to_medium_cylinder")
class Task11ParallelPourFlaskToSmallBeakerThenTubeToMediumCylinderConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["First, pick up the <flask_0> containing <KMnO4 solution_0>."]
...
@register.add_task("11_parallel_pour_flask_to_small_beaker_then_tube_to_medium_cylinder")
class Task11ParallelPourFlaskToSmallBeakerThenTubeToMediumCylinderTask(PrimitiveTask):
