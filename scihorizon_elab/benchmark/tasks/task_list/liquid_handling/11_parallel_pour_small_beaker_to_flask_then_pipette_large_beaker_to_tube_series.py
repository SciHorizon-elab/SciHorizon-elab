...
@register.add_config_manager("11_parallel_pour_small_beaker_to_flask_then_pipette_large_beaker_to_tube")
class Task11ParallelPourSmallBeakerToFlaskThenPipetteLargeBeakerToTubeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["First, pick up the <small_beaker_0> containing <CuSO4 solution_0>."]
...
@register.add_task("11_parallel_pour_small_beaker_to_flask_then_pipette_large_beaker_to_tube")
class Task11ParallelPourSmallBeakerToFlaskThenPipetteLargeBeakerToTubeTask(PrimitiveTask):
