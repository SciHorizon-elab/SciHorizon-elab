...
@register.add_config_manager("1_pour_flask_into_small_beaker")
class Task1PourFlaskIntoSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick up <flask_0> containing <CuSO4 solution_0>."]
...
@register.add_task("1_pour_flask_into_small_beaker")
class Task1PourFlaskIntoSmallBeakerTask(PrimitiveTask):
