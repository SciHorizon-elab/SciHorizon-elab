...
@register.add_config_manager("1_pour_small_beaker_into_small_beaker")
class Task1PourSmallBeakerIntoSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick up <small_beaker_0> containing <CuSO4 solution_0>."]
...
@register.add_task("1_pour_small_beaker_into_small_beaker")
class Task1PourSmallBeakerIntoSmallBeakerTask(PrimitiveTask):
