...
@register.add_config_manager("1_pour_small_beaker_into_tube")
class Task1PourSmallBeakerIntoTubeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            solution_rgba=[0.75, 0.9, 0.55, 0.4],
        )
...
@register.add_task("1_pour_small_beaker_into_tube")
class Task1PourSmallBeakerIntoTubeTask(PrimitiveTask):
