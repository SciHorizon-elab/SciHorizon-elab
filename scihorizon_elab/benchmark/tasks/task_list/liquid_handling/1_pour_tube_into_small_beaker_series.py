...
@register.add_config_manager("1_pour_tube_into_small_beaker")
class Task1PourTubeIntoSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pick up <tube_0> containing <CuSO4 solution_0>."]
...
@register.add_task("1_pour_tube_into_small_beaker")
class Task1PourTubeIntoSmallBeakerTask(PrimitiveTask):
