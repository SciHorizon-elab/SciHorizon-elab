...
@register.add_config_manager("2_mechanical_pipette_large_beaker_to_flask_twice")
class Task2MechanicalPipetteLargeBeakerToFlaskTwiceConfigManager(BenchTaskConfigManager):
...
@register.add_task("2_mechanical_pipette_large_beaker_to_flask_twice")
class Task2MechanicalPipetteLargeBeakerToFlaskTwiceTask(PrimitiveTask):
