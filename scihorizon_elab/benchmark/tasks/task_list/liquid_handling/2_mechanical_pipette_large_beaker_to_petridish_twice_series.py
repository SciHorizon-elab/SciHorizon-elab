...
@register.add_config_manager("2_mechanical_pipette_large_beaker_to_petridish_twice")
class Task2MechanicalPipetteLargeBeakerToPetridishTwiceConfigManager(BenchTaskConfigManager):
...
@register.add_task("2_mechanical_pipette_large_beaker_to_petridish_twice")
class Task2MechanicalPipetteLargeBeakerToPetridishTwiceTask(PrimitiveTask):
