...
@register.add_config_manager("2_mechanical_pipette_large_beaker_to_tube_twice")
class Task2MechanicalPipetteLargeBeakerToTubeTwiceConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0150, 0.0860), random.uniform(-0.0460, 0.0220), 0.8],
...
@register.add_task("2_mechanical_pipette_large_beaker_to_tube_twice")
class Task2MechanicalPipetteLargeBeakerToTubeTwiceTask(PrimitiveTask):
