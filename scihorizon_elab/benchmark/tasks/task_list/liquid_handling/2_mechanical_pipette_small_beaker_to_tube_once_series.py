...
@register.add_config_manager("2_mechanical_pipette_small_beaker_to_tube_once")
class Task2MechanicalPipetteSmallBeakerToTubeOnceConfigManager(BenchTaskConfigManager):
...
@register.add_task("2_mechanical_pipette_small_beaker_to_tube_once")
class Task2MechanicalPipetteSmallBeakerToTubeOnceTask(PrimitiveTask):
