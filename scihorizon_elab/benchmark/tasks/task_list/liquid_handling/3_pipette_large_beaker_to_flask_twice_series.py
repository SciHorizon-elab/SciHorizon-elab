...
@register.add_config_manager("3_pipette_large_beaker_to_flask_twice")
class Task3PipetteLargeBeakerToFlaskTwiceConfigManager(BenchTaskConfigManager):
...
@register.add_task("3_pipette_large_beaker_to_flask_twice")
class Task3PipetteLargeBeakerToFlaskTwiceTask(PrimitiveTask):
