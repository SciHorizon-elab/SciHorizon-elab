...
@register.add_config_manager("3_pipette_large_beaker_to_petridish_twice")
class Task3PipetteLargeBeakerToPetridishTwiceConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0150, 0.0860), random.uniform(-0.0825, -0.0145), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0130, 0.0760), random.uniform(0.0935, 0.1565), 0.8],
        )
        obj_config["class"] = "ChemistryContainer"
    ...
    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            ...
            dict(dispense=dict(target_container='petri_dish_0', tool='pipette_0', robot='robot')),
            dict(aspirate=dict(source_container='small_beaker_0', tool='pipette_0', robot='robot')),
            dict(dispense=dict(target_container='petri_dish_0', tool='pipette_0', robot='robot')),
        ]
...
@register.add_task("3_pipette_large_beaker_to_petridish_twice")
class Task3PipetteLargeBeakerToPetridishTwiceTask(PrimitiveTask):
