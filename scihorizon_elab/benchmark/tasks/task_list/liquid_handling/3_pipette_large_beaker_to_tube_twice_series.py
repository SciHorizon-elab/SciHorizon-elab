...
@register.add_config_manager("3_pipette_large_beaker_to_tube_twice")
class Task3PipetteLargeBeakerToTubeTwiceConfigManager(BenchTaskConfigManager):
...
@register.add_task("3_pipette_large_beaker_to_tube_twice")
class Task3PipetteLargeBeakerToTubeTwiceTask(PrimitiveTask):
