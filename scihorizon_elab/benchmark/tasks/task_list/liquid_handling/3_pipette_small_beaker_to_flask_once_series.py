...
@register.add_config_manager("3_pipette_small_beaker_to_flask_once")
class Task3PipetteSmallBeakerToFlaskOnceConfigManager(BenchTaskConfigManager):
...
@register.add_task("3_pipette_small_beaker_to_flask_once")
class Task3PipetteSmallBeakerToFlaskOnceTask(PrimitiveTask):
