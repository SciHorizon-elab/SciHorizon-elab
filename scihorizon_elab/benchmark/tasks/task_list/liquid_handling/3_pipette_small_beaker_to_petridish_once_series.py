...
@register.add_config_manager("3_pipette_small_beaker_to_petridish_once")
class Task3PipetteSmallBeakerToPetridishOnceConfigManager(BenchTaskConfigManager):
...
@register.add_task("3_pipette_small_beaker_to_petridish_once")
class Task3PipetteSmallBeakerToPetridishOnceTask(PrimitiveTask):
