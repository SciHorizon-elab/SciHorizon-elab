...
@register.add_config_manager("3_pipette_small_beaker_to_tube_once")
class Task3PipetteSmallBeakerToTubeOnceConfigManager(BenchTaskConfigManager):
    ...
    def load_init_containers(self, init_container):
        if init_container is None or init_container == "chemistry_tube_stand":
            container_config = dict(
                ...
                position=[random.uniform(0, 0.1175), random.uniform(-0.1300, 0.3300), 0.8],
            )
...
@register.add_task("3_pipette_small_beaker_to_tube_once")
class Task3PipetteSmallBeakerToTubeOnceTask(PrimitiveTask):
