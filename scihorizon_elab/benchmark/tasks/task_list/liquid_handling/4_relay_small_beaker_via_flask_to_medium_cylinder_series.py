...
@register.add_config_manager("4_relay_small_beaker_via_flask_to_medium_cylinder")
class Task4RelaySmallBeakerViaFlaskToMediumCylinderConfigManager(BenchTaskConfigManager):
...
@register.add_task("4_relay_small_beaker_via_flask_to_medium_cylinder")
class Task4RelaySmallBeakerViaFlaskToMediumCylinderTask(PrimitiveTask):
