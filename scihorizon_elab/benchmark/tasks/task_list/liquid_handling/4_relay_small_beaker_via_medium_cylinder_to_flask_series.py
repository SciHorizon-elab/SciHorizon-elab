...
@register.add_config_manager("4_relay_small_beaker_via_medium_cylinder_to_flask")
class Task4RelaySmallBeakerViaMediumCylinderToFlaskConfigManager(BenchTaskConfigManager):
...
@register.add_task("4_relay_small_beaker_via_medium_cylinder_to_flask")
class Task4RelaySmallBeakerViaMediumCylinderToFlaskTask(PrimitiveTask):
