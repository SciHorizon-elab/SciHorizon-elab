...
@register.add_config_manager("4_relay_tube_via_small_beaker_to_medium_cylinder")
class Task4RelayTubeViaSmallBeakerToMediumCylinderConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0050, 0.0550), random.uniform(-0.0590, -0.0090), 0.8],
            solution="CuSO4_solution_1",
            solution_rgba=[0.0, 0.45, 1.0, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
...
@register.add_task("4_relay_tube_via_small_beaker_to_medium_cylinder")
class Task4RelayTubeViaSmallBeakerToMediumCylinderTask(PrimitiveTask):
