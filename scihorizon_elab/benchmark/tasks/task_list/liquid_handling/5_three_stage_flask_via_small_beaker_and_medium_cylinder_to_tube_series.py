...
@register.add_config_manager("5_three_stage_flask_via_small_beaker_and_medium_cylinder_to_tube")
class Task5ThreeStageFlaskViaSmallBeakerAndMediumCylinderToTubeConfigManager(BenchTaskConfigManager):
...
@register.add_task("5_three_stage_flask_via_small_beaker_and_medium_cylinder_to_tube")
class Task5ThreeStageFlaskViaSmallBeakerAndMediumCylinderToTubeTask(PrimitiveTask):
