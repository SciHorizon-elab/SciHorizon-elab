...
@register.add_config_manager("5_three_stage_small_beaker_via_tube_and_flask_to_medium_cylinder")
class Task5ThreeStageSmallBeakerViaTubeAndFlaskToMediumCylinderConfigManager(BenchTaskConfigManager):
...
@register.add_task("5_three_stage_small_beaker_via_tube_and_flask_to_medium_cylinder")
class Task5ThreeStageSmallBeakerViaTubeAndFlaskToMediumCylinderTask(PrimitiveTask):
