...
@register.add_config_manager("5_three_stage_tube_via_small_beaker_and_flask_to_medium_cylinder")
class Task5ThreeStageTubeViaSmallBeakerAndFlaskToMediumCylinderConfigManager(BenchTaskConfigManager):
...
@register.add_task("5_three_stage_tube_via_small_beaker_and_flask_to_medium_cylinder")
class Task5ThreeStageTubeViaSmallBeakerAndFlaskToMediumCylinderTask(PrimitiveTask):
