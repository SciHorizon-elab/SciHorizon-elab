...
@register.add_config_manager("6_ordered_converge_medium_cylinder_and_tube_into_flask")
class Task6OrderedConvergeMediumCylinderAndTubeIntoFlaskConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.0550, -0.0050), random.uniform(-0.0935, -0.0435), 0.8],
...
@register.add_task("6_ordered_converge_medium_cylinder_and_tube_into_flask")
class Task6OrderedConvergeMediumCylinderAndTubeIntoFlaskTask(PrimitiveTask):
