...
@register.add_config_manager("6_ordered_converge_two_tubes_into_small_beaker")
class Task6OrderedConvergeTwoTubesIntoSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.2985, -0.2275), random.uniform(0.0910, 0.1590), 0.8],
        )
...
@register.add_task("6_ordered_converge_two_tubes_into_small_beaker")
class Task6OrderedConvergeTwoTubesIntoSmallBeakerTask(PrimitiveTask):
