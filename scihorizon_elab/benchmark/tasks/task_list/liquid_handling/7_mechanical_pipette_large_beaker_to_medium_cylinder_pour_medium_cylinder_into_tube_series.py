...
@register.add_config_manager("7_mechanical_pipette_large_beaker_to_medium_cylinder_pour_medium_cylinder_into_tube")
class Task7MechanicalPipetteLargeBeakerToMediumCylinderPourMediumCylinderIntoTubeConfigManager(BenchTaskConfigManager):
...
@register.add_task("7_mechanical_pipette_large_beaker_to_medium_cylinder_pour_medium_cylinder_into_tube")
class Task7MechanicalPipetteLargeBeakerToMediumCylinderPourMediumCylinderIntoTubeTask(PrimitiveTask):
