...
@register.add_config_manager("7_pipette_small_beaker_to_flask_pour_flask_into_medium_cylinder")
class Task7PipetteSmallBeakerToFlaskPourFlaskIntoMediumCylinderConfigManager(BenchTaskConfigManager):
...
@register.add_task("7_pipette_small_beaker_to_flask_pour_flask_into_medium_cylinder")
class Task7PipetteSmallBeakerToFlaskPourFlaskIntoMediumCylinderTask(PrimitiveTask):
