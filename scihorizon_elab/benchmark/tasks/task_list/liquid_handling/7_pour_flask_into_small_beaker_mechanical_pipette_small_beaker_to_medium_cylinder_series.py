...
@register.add_config_manager("7_pour_flask_into_small_beaker_mechanical_pipette_small_beaker_to_medium_cylinder")
class Task7PourFlaskIntoSmallBeakerMechanicalPipetteSmallBeakerToMediumCylinderConfigManager(BenchTaskConfigManager):
...
@register.add_task("7_pour_flask_into_small_beaker_mechanical_pipette_small_beaker_to_medium_cylinder")
class Task7PourFlaskIntoSmallBeakerMechanicalPipetteSmallBeakerToMediumCylinderTask(PrimitiveTask):
