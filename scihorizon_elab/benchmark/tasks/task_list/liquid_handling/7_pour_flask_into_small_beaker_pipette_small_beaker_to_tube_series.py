...
@register.add_config_manager("7_pour_flask_into_small_beaker_pipette_small_beaker_to_tube")
class Task7PourFlaskIntoSmallBeakerPipetteSmallBeakerToTubeConfigManager(BenchTaskConfigManager):
...
@register.add_task("7_pour_flask_into_small_beaker_pipette_small_beaker_to_tube")
class Task7PourFlaskIntoSmallBeakerPipetteSmallBeakerToTubeTask(PrimitiveTask):
