...
@register.add_config_manager("7_pour_medium_cylinder_into_small_beaker_mechanical_pipette_small_beaker_to_tube")
class Task7PourMediumCylinderIntoSmallBeakerMechanicalPipetteSmallBeakerToTubeConfigManager(BenchTaskConfigManager):
...
@register.add_task("7_pour_medium_cylinder_into_small_beaker_mechanical_pipette_small_beaker_to_tube")
class Task7PourMediumCylinderIntoSmallBeakerMechanicalPipetteSmallBeakerToTubeTask(PrimitiveTask):
