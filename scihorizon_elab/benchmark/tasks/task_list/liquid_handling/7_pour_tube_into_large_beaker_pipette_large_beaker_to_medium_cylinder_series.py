...
@register.add_config_manager("7_pour_tube_into_large_beaker_pipette_large_beaker_to_medium_cylinder")
class Task7PourTubeIntoLargeBeakerPipetteLargeBeakerToMediumCylinderConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0860, -0.0150), random.uniform(0.0910, 0.1590), 0.8],
            solution="FeCl2_solution_1",
            solution_rgba=[0.56, 0.75, 0.56, 0.4],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0550, -0.0050), random.uniform(-0.0590, -0.0090), 0.8],
            solution="FeCl2_solution_1",
            solution_rgba=[0.56, 0.75, 0.56, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
...
@register.add_task("7_pour_tube_into_large_beaker_pipette_large_beaker_to_medium_cylinder")
class Task7PourTubeIntoLargeBeakerPipetteLargeBeakerToMediumCylinderTask(PrimitiveTask):
