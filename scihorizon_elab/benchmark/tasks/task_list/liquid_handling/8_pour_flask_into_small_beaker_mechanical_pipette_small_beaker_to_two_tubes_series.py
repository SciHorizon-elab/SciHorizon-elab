...
@register.add_config_manager("8_pour_flask_into_small_beaker_mechanical_pipette_small_beaker_to_two_tubes")
class Task8PourFlaskIntoSmallBeakerMechanicalPipetteSmallBeakerToTwoTubesConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0860, -0.0150), random.uniform(0.2130, 0.2810), 0.8],
            solution="CuSO4_solution_1",
            solution_rgba=[0.0, 0.45, 1.0, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0830, -0.0150), random.uniform(0.0970, 0.1230), 0.8],
        )
    ...
    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            ...
            dict(dispense=dict(target_container='tube_0', tool='mechanical_pipette_0', robot='robot')),
            dict(aspirate=dict(
            source_container='small_beaker_0',
            tool='mechanical_pipette_0',
            robot='robot',
        )),
            dict(dispense=dict(target_container='tube_1', tool='mechanical_pipette_0', robot='robot')),
        ]
        self.config["task"]["conditions"] = conditions_config


@register.add_task("8_pour_flask_into_small_beaker_mechanical_pipette_small_beaker_to_two_tubes")
class Task8PourFlaskIntoSmallBeakerMechanicalPipetteSmallBeakerToTwoTubesTask(PrimitiveTask):
