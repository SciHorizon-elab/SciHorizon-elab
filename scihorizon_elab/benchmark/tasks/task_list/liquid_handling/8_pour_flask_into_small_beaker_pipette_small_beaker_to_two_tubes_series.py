...
@register.add_config_manager("8_pour_flask_into_small_beaker_pipette_small_beaker_to_two_tubes")
class Task8PourFlaskIntoSmallBeakerPipetteSmallBeakerToTwoTubesConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <flask_0> which contains <FeCl2 solution_0>."]
...
@register.add_task("8_pour_flask_into_small_beaker_pipette_small_beaker_to_two_tubes")
class Task8PourFlaskIntoSmallBeakerPipetteSmallBeakerToTwoTubesTask(PrimitiveTask):
