...
@register.add_config_manager("8_pour_medium_cylinder_into_large_beaker_mechanical_pipette_large_beaker_to_two_tubes_and_flask")
class Task8PourMediumCylinderIntoLargeBeakerMechanicalPipetteLargeBeakerToTwoTubesAndFlaskConfigManager(BenchTaskConfigManager):
...
@register.add_task("8_pour_medium_cylinder_into_large_beaker_mechanical_pipette_large_beaker_to_two_tubes_and_flask")
class Task8PourMediumCylinderIntoLargeBeakerMechanicalPipetteLargeBeakerToTwoTubesAndFlaskTask(PrimitiveTask):
