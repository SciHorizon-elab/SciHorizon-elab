...
@register.add_config_manager("8_pour_medium_cylinder_into_large_beaker_pipette_large_beaker_to_two_tubes_and_flask")
class Task8PourMediumCylinderIntoLargeBeakerPipetteLargeBeakerToTwoTubesAndFlaskConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.2920, -0.1550), random.uniform(0.1050, 0.2420), 0.8],
            solution="CuSO4_1",
            solution_rgba=[0, 0.45, 1, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <cylinder_mid_0> which contains <CuSO4 solution_0>."]
...
@register.add_task("8_pour_medium_cylinder_into_large_beaker_pipette_large_beaker_to_two_tubes_and_flask")
class Task8PourMediumCylinderIntoLargeBeakerPipetteLargeBeakerToTwoTubesAndFlaskTask(PrimitiveTask):
