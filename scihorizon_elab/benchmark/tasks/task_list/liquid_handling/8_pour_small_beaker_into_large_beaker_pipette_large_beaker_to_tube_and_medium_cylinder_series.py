...
@register.add_config_manager("8_pour_small_beaker_into_large_beaker_pipette_large_beaker_to_tube_and_medium_cylinder")
class Task8PourSmallBeakerIntoLargeBeakerPipetteLargeBeakerToTubeAndMediumCylinderConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.2860, -0.1550), random.uniform(0.0625, 0.1875), 0.8],
        )
        obj_config["class"] = "ChemistryContainer"
        obj_config["randomness"] = dict(pos=[0.0200, 0.0200, 0], quat=[0, 0, 0.05])
        self.config["task"]["components"].append(obj_config)
...
@register.add_task("8_pour_small_beaker_into_large_beaker_pipette_large_beaker_to_tube_and_medium_cylinder")
class Task8PourSmallBeakerIntoLargeBeakerPipetteLargeBeakerToTubeAndMediumCylinderTask(PrimitiveTask):
