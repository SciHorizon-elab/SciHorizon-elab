...
@register.add_config_manager("8_pour_tube_into_large_beaker_mechanical_pipette_large_beaker_to_flask_medium_cylinder_and_tube")
class Task8PourTubeIntoLargeBeakerMechanicalPipetteLargeBeakerToFlaskMediumCylinderAndTubeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.1460, -0.0150), random.uniform(-0.1300, -0.0050), 0.8],
            solution="CuSO4_solution_1",
            solution_rgba=[0.0, 0.45, 1.0, 0.4],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0830, -0.0150), random.uniform(0.0850, 0.1110), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.3300, -0.1930), random.uniform(0.1050, 0.2420), 0.8],
            solution="CuSO4_solution_1",
            solution_rgba=[0.0, 0.45, 1.0, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0550, -0.0050), random.uniform(0.1910, 0.2410), 0.8],
            solution="CuSO4_solution_1",
            solution_rgba=[0.0, 0.45, 1.0, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
...
@register.add_task("8_pour_tube_into_large_beaker_mechanical_pipette_large_beaker_to_flask_medium_cylinder_and_tube")
class Task8PourTubeIntoLargeBeakerMechanicalPipetteLargeBeakerToFlaskMediumCylinderAndTubeTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.dispense, target_container_name="tube_1", dwell_steps=20),
