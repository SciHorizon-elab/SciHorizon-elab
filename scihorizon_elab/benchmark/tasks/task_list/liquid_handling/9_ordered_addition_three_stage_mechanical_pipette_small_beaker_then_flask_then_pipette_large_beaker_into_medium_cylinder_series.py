...
@register.add_config_manager("9_ordered_addition_three_stage_mechanical_pipette_small_beaker_then_flask_then_pipette_large_beaker_into_medium_cylinder")
class Task9OrderedAdditionThreeStageMechanicalPipetteSmallBeakerThenFlaskThenPipetteLargeBeakerIntoMediumCylinderConfigManager(BenchTaskConfigManager):
...
@register.add_task("9_ordered_addition_three_stage_mechanical_pipette_small_beaker_then_flask_then_pipette_large_beaker_into_medium_cylinder")
class Task9OrderedAdditionThreeStageMechanicalPipetteSmallBeakerThenFlaskThenPipetteLargeBeakerIntoMediumCylinderTask(PrimitiveTask):
