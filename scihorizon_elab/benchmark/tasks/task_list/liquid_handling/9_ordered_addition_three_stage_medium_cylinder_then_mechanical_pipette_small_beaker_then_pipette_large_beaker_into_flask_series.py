...
@register.add_config_manager("9_ordered_addition_three_stage_medium_cylinder_then_mechanical_pipette_small_beaker_then_pipette_large_beaker_into_flask")
class Task9OrderedAdditionThreeStageMediumCylinderThenMechanicalPipetteSmallBeakerThenPipetteLargeBeakerIntoFlaskConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.0250, 0.0250), random.uniform(0.0830, 0.1330), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.1440, 0.2810), random.uniform(0.0565, 0.1935), 0.8],
        )
        obj_config["class"] = "ChemistryContainer"
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0340, 0.0340), random.uniform(0.2130, 0.2390), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.2765, -0.1455), random.uniform(0.0625, 0.1875), 0.8],
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <cylinder_mid_0> which contains <FeCl2 solution_0>."]
...
@register.add_task("9_ordered_addition_three_stage_medium_cylinder_then_mechanical_pipette_small_beaker_then_pipette_large_beaker_into_flask")
class Task9OrderedAdditionThreeStageMediumCylinderThenMechanicalPipetteSmallBeakerThenPipetteLargeBeakerIntoFlaskTask(PrimitiveTask):
