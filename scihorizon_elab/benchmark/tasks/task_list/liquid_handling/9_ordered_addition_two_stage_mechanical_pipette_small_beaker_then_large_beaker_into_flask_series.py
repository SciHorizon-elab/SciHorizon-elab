...
@register.add_config_manager("9_ordered_addition_two_stage_mechanical_pipette_small_beaker_then_large_beaker_into_flask")
class Task9OrderedAdditionTwoStageMechanicalPipetteSmallBeakerThenLargeBeakerIntoFlaskConfigManager(BenchTaskConfigManager):
    ...
    def get_condition_config(self, target_entity, **kwargs):
        conditions_config = [
            ...
            dict(is_grasped=dict(entities=['large_beaker_0'], robot='robot')),
            dict(pour_into=dict(
            target_entity='large_beaker_0',
...
@register.add_task("9_ordered_addition_two_stage_mechanical_pipette_small_beaker_then_large_beaker_into_flask")
class Task9OrderedAdditionTwoStageMechanicalPipetteSmallBeakerThenLargeBeakerIntoFlaskTask(PrimitiveTask):
