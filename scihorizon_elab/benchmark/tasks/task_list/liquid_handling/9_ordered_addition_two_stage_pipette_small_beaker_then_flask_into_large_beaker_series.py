...
@register.add_config_manager("9_ordered_addition_two_stage_pipette_small_beaker_then_flask_into_large_beaker")
class Task9OrderedAdditionTwoStagePipetteSmallBeakerThenFlaskIntoLargeBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            solution_rgba=[0.65, 0.85, 0.65, 0.4],
        )
        obj_config["class"] = "ChemistryContainer"
        obj_config["randomness"] = dict(pos=[0.0200, 0.0200, 0], quat=[0, 0, 0.05])
        self.config["task"]["components"].append(obj_config)
...
@register.add_task("9_ordered_addition_two_stage_pipette_small_beaker_then_flask_into_large_beaker")
class Task9OrderedAdditionTwoStagePipetteSmallBeakerThenFlaskIntoLargeBeakerTask(PrimitiveTask):
