...
@register.add_config_manager("1_stir_large_beaker_then_small_beaker")
class Task1StirLargeBeakerThenSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(0.0890, 0.0970), random.uniform(0.1210, 0.1290), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0720, -0.0010), random.uniform(0.1050, 0.1730), 0.8],
...
@register.add_task("1_stir_large_beaker_then_small_beaker")
class Task1StirLargeBeakerThenSmallBeakerTask(PrimitiveTask):
