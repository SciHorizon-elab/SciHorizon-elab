...
@register.add_config_manager("1_stir_large_beaker_then_two_small_beakers")
class Task1StirLargeBeakerThenTwoSmallBeakersConfigManager(BenchTaskConfigManager):
...
@register.add_task("1_stir_large_beaker_then_two_small_beakers")
class Task1StirLargeBeakerThenTwoSmallBeakersTask(PrimitiveTask):
