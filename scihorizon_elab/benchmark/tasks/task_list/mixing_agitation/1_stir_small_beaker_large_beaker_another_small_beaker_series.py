...
@register.add_config_manager("1_stir_small_beaker_large_beaker_another_small_beaker")
class Task1StirSmallBeakerLargeBeakerAnotherSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0355, 0.0355), random.uniform(-0.1155, -0.0475), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.2250, -0.0940), random.uniform(0.0625, 0.1875), 0.8],
        ...
        obj_config = dict(
            name="small_beaker_1",
            xml_path=name2class_xml["small_beaker"][-1],
            position=[random.uniform(0.0940, 0.1650), random.uniform(0.0910, 0.1590), 0.8],
...
@register.add_task("1_stir_small_beaker_large_beaker_another_small_beaker")
class Task1StirSmallBeakerLargeBeakerAnotherSmallBeakerTask(PrimitiveTask):
