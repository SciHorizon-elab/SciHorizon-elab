...
@register.add_config_manager("1_stir_small_beaker_then_large_beaker")
class Task1StirSmallBeakerThenLargeBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.1335, -0.1255), random.uniform(0.1210, 0.1290), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0355, 0.0355), random.uniform(0.1050, 0.1730), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0655, 0.0655), random.uniform(-0.1300, -0.0050), 0.8],
...
@register.add_task("1_stir_small_beaker_then_large_beaker")
class Task1StirSmallBeakerThenLargeBeakerTask(PrimitiveTask):
