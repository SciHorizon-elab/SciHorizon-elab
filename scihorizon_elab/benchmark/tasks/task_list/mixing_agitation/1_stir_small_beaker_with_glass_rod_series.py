...
@register.add_config_manager("1_stir_small_beaker_with_glass_rod")
class Task1StirSmallBeakerWithGlassRodConfigManager(BenchTaskConfigManager):
...
@register.add_task("1_stir_small_beaker_with_glass_rod")
class Task1StirSmallBeakerWithGlassRodTask(PrimitiveTask):
