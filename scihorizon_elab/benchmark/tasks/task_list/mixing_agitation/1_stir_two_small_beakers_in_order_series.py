...
@register.add_config_manager("1_stir_two_small_beakers_in_order")
class Task1StirTwoSmallBeakersInOrderConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            solution_rgba=[0.55, 0.75, 0.35, 0.4],
        )
        ...
        obj_config = dict(
            name="small_beaker_1",
            xml_path=name2class_xml["small_beaker"][-1],
            position=[random.uniform(-0.0355, 0.0355), random.uniform(0.1260, 0.1940), 0.8],
...
@register.add_task("1_stir_two_small_beakers_in_order")
class Task1StirTwoSmallBeakersInOrderTask(PrimitiveTask):
