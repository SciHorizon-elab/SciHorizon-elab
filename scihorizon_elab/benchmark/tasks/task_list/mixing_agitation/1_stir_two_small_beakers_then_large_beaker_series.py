...
@register.add_config_manager("1_stir_two_small_beakers_then_large_beaker")
class Task1StirTwoSmallBeakersThenLargeBeakerConfigManager(BenchTaskConfigManager):
...
@register.add_task("1_stir_two_small_beakers_then_large_beaker")
class Task1StirTwoSmallBeakersThenLargeBeakerTask(PrimitiveTask):
