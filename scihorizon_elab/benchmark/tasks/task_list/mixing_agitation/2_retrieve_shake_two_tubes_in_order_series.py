...
@register.add_config_manager("2_retrieve_shake_two_tubes_in_order")
class Task2RetrieveShakeTwoTubesInOrderConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Retrieve <tube_0> and <tube_1> in the specified order."]
...
@register.add_task("2_retrieve_shake_two_tubes_in_order")
class Task2RetrieveShakeTwoTubesInOrderTask(PrimitiveTask):
