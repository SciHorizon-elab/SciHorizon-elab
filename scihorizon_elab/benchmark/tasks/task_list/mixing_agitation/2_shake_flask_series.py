...
@register.add_config_manager("2_shake_flask")
class Task2ShakeFlaskConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <flask_0> containing <CuSO4 solution_0>."]
...
@register.add_task("2_shake_flask")
class Task2ShakeFlaskTask(PrimitiveTask):
