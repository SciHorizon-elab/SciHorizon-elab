...
@register.add_config_manager("2_shake_flask_then_two_tubes")
class Task2ShakeFlaskThenTwoTubesConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Shake the flask_0 containing KMnO4 solution_0."]
...
@register.add_task("2_shake_flask_then_two_tubes")
class Task2ShakeFlaskThenTwoTubesTask(PrimitiveTask):
