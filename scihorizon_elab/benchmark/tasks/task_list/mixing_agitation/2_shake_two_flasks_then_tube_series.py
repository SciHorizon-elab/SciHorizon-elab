...
@register.add_config_manager("2_shake_two_flasks_then_tube")
class Task2ShakeTwoFlasksThenTubeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            name="flask_1",
            xml_path=name2class_xml["flask"][-1],
            position=[random.uniform(0.0150, 0.1520), random.uniform(0.1170, 0.2540), 0.8],
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Shake flask_0 containing FeCl2 solution_0."]
...
@register.add_task("2_shake_two_flasks_then_tube")
class Task2ShakeTwoFlasksThenTubeTask(PrimitiveTask):
