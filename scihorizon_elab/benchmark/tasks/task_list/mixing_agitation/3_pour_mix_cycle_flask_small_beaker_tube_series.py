...
@register.add_config_manager("3_pour_mix_cycle_flask_small_beaker_tube")
class Task3PourMixCycleFlaskSmallBeakerTubeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["In this order, pour the <CuSO4 solution_0> from the <flask_0> into the <small_beaker_0>."]
...
@register.add_task("3_pour_mix_cycle_flask_small_beaker_tube")
class Task3PourMixCycleFlaskSmallBeakerTubeTask(PrimitiveTask):
