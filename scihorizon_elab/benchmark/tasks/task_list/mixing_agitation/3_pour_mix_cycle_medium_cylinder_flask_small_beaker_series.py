...
@register.add_config_manager("3_pour_mix_cycle_medium_cylinder_flask_small_beaker")
class Task3PourMixCycleMediumCylinderFlaskSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour the FeCl2 solution_0 from the cylinder_mid_0 into the flask_0."]
...
@register.add_task("3_pour_mix_cycle_medium_cylinder_flask_small_beaker")
class Task3PourMixCycleMediumCylinderFlaskSmallBeakerTask(PrimitiveTask):
