...
@register.add_config_manager("3_pour_mix_cycle_tube_small_beaker_flask")
class Task3PourMixCycleTubeSmallBeakerFlaskConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Complete the mixing cycle in this order: pour the <KMnO4 solution_0> from the <tube_0> into the <small_beaker_0>."]
...
@register.add_task("3_pour_mix_cycle_tube_small_beaker_flask")
class Task3PourMixCycleTubeSmallBeakerFlaskTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.lift, lift_height=0.15),
            partial(SkillLib.pour_to_entity, target_container_name="flask_0"),
