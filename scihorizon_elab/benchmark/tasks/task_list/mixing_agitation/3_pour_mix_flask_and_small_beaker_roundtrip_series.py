...
@register.add_config_manager("3_pour_mix_flask_and_small_beaker_roundtrip")
class Task3PourMixFlaskAndSmallBeakerRoundtripConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pick up the <flask_0> containing <FeCl2 solution_0>."]
...
@register.add_task("3_pour_mix_flask_and_small_beaker_roundtrip")
class Task3PourMixFlaskAndSmallBeakerRoundtripTask(PrimitiveTask):
