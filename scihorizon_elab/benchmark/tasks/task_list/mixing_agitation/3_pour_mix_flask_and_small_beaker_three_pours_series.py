...
@register.add_config_manager("3_pour_mix_flask_and_small_beaker_three_pours")
class Task3PourMixFlaskAndSmallBeakerThreePoursConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour the <FeCl2 solution_0> from the <flask_0> into the <small_beaker_0>."]
...
@register.add_task("3_pour_mix_flask_and_small_beaker_three_pours")
class Task3PourMixFlaskAndSmallBeakerThreePoursTask(PrimitiveTask):
