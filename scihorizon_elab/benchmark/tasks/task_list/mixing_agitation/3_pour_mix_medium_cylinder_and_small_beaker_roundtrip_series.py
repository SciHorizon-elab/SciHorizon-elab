...
@register.add_config_manager("3_pour_mix_medium_cylinder_and_small_beaker_roundtrip")
class Task3PourMixMediumCylinderAndSmallBeakerRoundtripConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour the CuSO4 solution from the cylinder_mid_0 into the small_beaker_0."]
...
@register.add_task("3_pour_mix_medium_cylinder_and_small_beaker_roundtrip")
class Task3PourMixMediumCylinderAndSmallBeakerRoundtripTask(PrimitiveTask):
