...
@register.add_config_manager("3_pour_mix_small_beaker_and_flask_roundtrip")
class Task3PourMixSmallBeakerAndFlaskRoundtripConfigManager(BenchTaskConfigManager):
...
@register.add_task("3_pour_mix_small_beaker_and_flask_roundtrip")
class Task3PourMixSmallBeakerAndFlaskRoundtripTask(PrimitiveTask):
