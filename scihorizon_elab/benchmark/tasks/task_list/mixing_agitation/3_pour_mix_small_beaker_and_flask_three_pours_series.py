...
@register.add_config_manager("3_pour_mix_small_beaker_and_flask_three_pours")
class Task3PourMixSmallBeakerAndFlaskThreePoursConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour the <CuSO4 solution_0> from the <small_beaker_0> into the <flask_0>."]
...
@register.add_task("3_pour_mix_small_beaker_and_flask_three_pours")
class Task3PourMixSmallBeakerAndFlaskThreePoursTask(PrimitiveTask):
