...
@register.add_config_manager("3_pour_mix_tube_and_small_beaker_roundtrip")
class Task3PourMixTubeAndSmallBeakerRoundtripConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pour the <FeCl2 solution_0> from the <tube_0> into the <small_beaker_0>."]
...
@register.add_task("3_pour_mix_tube_and_small_beaker_roundtrip")
class Task3PourMixTubeAndSmallBeakerRoundtripTask(PrimitiveTask):
