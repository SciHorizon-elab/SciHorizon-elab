...
@register.add_config_manager("4_mechanical_pipette_large_beaker_to_tube_then_shake")
class Task4MechanicalPipetteLargeBeakerToTubeThenShakeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(0.0150, 0.0830), random.uniform(0.1120, 0.1380), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0150, 0.1460), random.uniform(-0.1030, 0.0220), 0.8],
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Use the <mechanical_pipette_0> to aspirate <CuSO4 solution_0> from the <large_beaker_0>."]
...
@register.add_task("4_mechanical_pipette_large_beaker_to_tube_then_shake")
class Task4MechanicalPipetteLargeBeakerToTubeThenShakeTask(PrimitiveTask):
