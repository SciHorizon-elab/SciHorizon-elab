...
@register.add_config_manager("4_mechanical_pipette_small_beaker_and_pour_flask_to_tube_then_shake")
class Task4MechanicalPipetteSmallBeakerAndPourFlaskToTubeThenShakeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["In this exact order, use the <mechanical_pipette_0> to add <KMnO4 solution_0> from the <small_beaker_0> to the <tube_0>."]
    ...
    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            ...
            dict(pour_into=dict(target_entity='flask_0', receiver_container='tube_0', robot='robot')),
...
@register.add_task("4_mechanical_pipette_small_beaker_and_pour_flask_to_tube_then_shake")
class Task4MechanicalPipetteSmallBeakerAndPourFlaskToTubeThenShakeTask(PrimitiveTask):
