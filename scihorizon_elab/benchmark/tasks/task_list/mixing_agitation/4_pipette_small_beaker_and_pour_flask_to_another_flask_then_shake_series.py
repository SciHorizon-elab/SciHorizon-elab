...
@register.add_config_manager("4_pipette_small_beaker_and_pour_flask_to_another_flask_then_shake")
class Task4PipetteSmallBeakerAndPourFlaskToAnotherFlaskThenShakeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.3300, -0.1930), random.uniform(0.1170, 0.2540), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0830, -0.0150), random.uniform(0.1170, 0.1880), 0.8],
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Use the <pipette_0> to add <CuSO4 solution_0> from the <small_beaker_0> to the <flask_0>."]
...
@register.add_task("4_pipette_small_beaker_and_pour_flask_to_another_flask_then_shake")
class Task4PipetteSmallBeakerAndPourFlaskToAnotherFlaskThenShakeTask(PrimitiveTask):
