...
@register.add_config_manager("4_pipette_small_beaker_and_pour_tube_to_large_beaker_then_stir")
class Task4PipetteSmallBeakerAndPourTubeToLargeBeakerThenStirConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.2240, -0.0930), random.uniform(0.0625, 0.1875), 0.8],
        )
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0860, -0.0150), random.uniform(-0.1155, -0.0475), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0030, 0.0050), random.uniform(0.1210, 0.1290), 0.8],
        )
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Use the <pipette_0> to add <CuSO4 solution_0> from the <small_beaker_0> to the <large_beaker_0> in this exact order."]
...
@register.add_task("4_pipette_small_beaker_and_pour_tube_to_large_beaker_then_stir")
class Task4PipetteSmallBeakerAndPourTubeToLargeBeakerThenStirTask(PrimitiveTask):
