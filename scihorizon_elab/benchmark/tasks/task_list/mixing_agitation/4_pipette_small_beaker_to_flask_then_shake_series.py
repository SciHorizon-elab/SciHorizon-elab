...
@register.add_config_manager("4_pipette_small_beaker_to_flask_then_shake")
class Task4PipetteSmallBeakerToFlaskThenShakeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Use the <pipette_0> to aspirate <KMnO4 solution_0> from the <small_beaker_0>."]
...
@register.add_task("4_pipette_small_beaker_to_flask_then_shake")
class Task4PipetteSmallBeakerToFlaskThenShakeTask(PrimitiveTask):
