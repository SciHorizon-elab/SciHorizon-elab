...
@register.add_config_manager("4_pour_flask_to_small_beaker_then_stir")
class Task4PourFlaskToSmallBeakerThenStirConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Pour the <CuSO4 solution_0> from the <flask_0> into the <small_beaker_0>."]
...
@register.add_task("4_pour_flask_to_small_beaker_then_stir")
class Task4PourFlaskToSmallBeakerThenStirTask(PrimitiveTask):
