...
@register.add_config_manager("4_pour_small_beaker_to_flask_then_shake")
class Task4PourSmallBeakerToFlaskThenShakeConfigManager(BenchTaskConfigManager):
...
@register.add_task("4_pour_small_beaker_to_flask_then_shake")
class Task4PourSmallBeakerToFlaskThenShakeTask(PrimitiveTask):
