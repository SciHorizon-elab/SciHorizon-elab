...
@register.add_config_manager("4_pour_small_beaker_to_tube_then_shake")
class Task4PourSmallBeakerToTubeThenShakeConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            solution_rgba=[0.5, 0.8, 0.45, 0.4],
        )
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pour the <FeCl2 solution_0> from the <small_beaker_0> into the <tube_0>."]
...
@register.add_task("4_pour_small_beaker_to_tube_then_shake")
class Task4PourSmallBeakerToTubeThenShakeTask(PrimitiveTask):
