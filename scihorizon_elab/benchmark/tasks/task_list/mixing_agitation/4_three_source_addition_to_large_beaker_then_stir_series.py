...
@register.add_config_manager("4_three_source_addition_to_large_beaker_then_stir")
class Task4ThreeSourceAdditionToLargeBeakerThenStirConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0150, 0.0830), random.uniform(0.2220, 0.2930), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0040, 0.0040), random.uniform(0.1240, 0.1320), 0.8],
        )
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pour <CuSO4 solution_0> from <flask_0> into <large_beaker_0>."]
    ...
    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            ...
            dict(dispense=dict(target_container='large_beaker_0', tool='pipette_0', robot='robot')),
            dict(dispense=dict(
...
@register.add_task("4_three_source_addition_to_large_beaker_then_stir")
class Task4ThreeSourceAdditionToLargeBeakerThenStirTask(PrimitiveTask):
    ...
    def get_expert_skill_sequence(self, physics):
        skill_sequence = [
            ...
            partial(SkillLib.dispense, target_container_name="large_beaker_0", dwell_steps=20),
            partial(SkillLib.drop),
