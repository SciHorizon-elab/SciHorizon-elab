...
@register.add_config_manager("5_pour_small_beaker_to_flask_wait_then_pipette_large_beaker_and_shake")
class Task5PourSmallBeakerToFlaskWaitThenPipetteLargeBeakerAndShakeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, init_container, **kwargs):
        self.config["task"]["instructions"] = ["Pour <CuSO4 solution_0> from the <small_beaker_0> into the <flask_0>."]
...
@register.add_task("5_pour_small_beaker_to_flask_wait_then_pipette_large_beaker_and_shake")
class Task5PourSmallBeakerToFlaskWaitThenPipetteLargeBeakerAndShakeTask(PrimitiveTask):
