...
@register.add_config_manager("5_stir_small_beaker_wait_then_mechanical_pipette_large_beaker_to_flask_and_shake")
class Task5StirSmallBeakerWaitThenMechanicalPipetteLargeBeakerToFlaskAndShakeConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Stir the <CuSO4 solution_0> in the <small_beaker_0> with the <glass_stirring_rod_0>."]
...
@register.add_task("5_stir_small_beaker_wait_then_mechanical_pipette_large_beaker_to_flask_and_shake")
class Task5StirSmallBeakerWaitThenMechanicalPipetteLargeBeakerToFlaskAndShakeTask(PrimitiveTask):
