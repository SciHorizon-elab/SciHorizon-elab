...
@register.add_config_manager("5_two_human_additions_stir_small_beaker_then_shake_tube")
class Task5TwoHumanAdditionsStirSmallBeakerThenShakeTubeConfigManager(BenchTaskConfigManager):
    ...
    def get_condition_config(self, target_entity, init_container, **kwargs):
        conditions_config = [
            ...
            dict(dispense=dict(target_container='tube_0', tool='pipette_0', robot='robot')),
            dict(shake=dict(entities=['tube_0'], robot='robot')),
        ]
        self.config["task"]["conditions"] = conditions_config


@register.add_task("5_two_human_additions_stir_small_beaker_then_shake_tube")
class Task5TwoHumanAdditionsStirSmallBeakerThenShakeTubeTask(PrimitiveTask):
