...
@register.add_config_manager("5_wait_then_stir_small_beaker")
class Task5WaitThenStirSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.0355, 0.0355), random.uniform(-0.0370, 0.0310), 0.8],
        )
...
@register.add_task("5_wait_then_stir_small_beaker")
class Task5WaitThenStirSmallBeakerTask(PrimitiveTask):
