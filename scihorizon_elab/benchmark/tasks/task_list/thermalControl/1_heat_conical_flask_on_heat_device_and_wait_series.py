...
@register.add_config_manager("1_heat_conical_flask_on_heat_device_and_wait")
class Task1HeatConicalFlaskOnHeatDeviceAndWaitConfigManager(BenchTaskConfigManager):
...
@register.add_task("1_heat_conical_flask_on_heat_device_and_wait")
class Task1HeatConicalFlaskOnHeatDeviceAndWaitTask(PrimitiveTask):
