...
@register.add_config_manager("1_heat_flask_on_heat_device_and_press")
class Task1HeatFlaskOnHeatDeviceAndPressConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Place the flask_0 containing KMnO4 solution_0 on the heat_device_0."]
...
@register.add_task("1_heat_flask_on_heat_device_and_press")
class Task1HeatFlaskOnHeatDeviceAndPressTask(PrimitiveTask):
