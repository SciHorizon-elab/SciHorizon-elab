...
@register.add_config_manager("1_heat_flask_on_heat_device_then_retrieve")
class Task1HeatFlaskOnHeatDeviceThenRetrieveConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.1270, 0.1270), random.uniform(0.1170, 0.2970), 0.8],
        )
...
@register.add_task("1_heat_flask_on_heat_device_then_retrieve")
class Task1HeatFlaskOnHeatDeviceThenRetrieveTask(PrimitiveTask):
