...
@register.add_config_manager("1_heat_flask_then_small_beaker_on_heat_device")
class Task1HeatFlaskThenSmallBeakerOnHeatDeviceConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        obj_config = dict(
            ...
            position=[random.uniform(-0.1710, -0.0340), random.uniform(0.0565, 0.1935), 0.8],
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.0760, 0.3300), random.uniform(0.0480, 0.2280), 0.8],
        )
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Place the <flask_0> containing <FeCl2 solution_0> on the <heat_device_0>."]
...
@register.add_task("1_heat_flask_then_small_beaker_on_heat_device")
class Task1HeatFlaskThenSmallBeakerOnHeatDeviceTask(PrimitiveTask):
