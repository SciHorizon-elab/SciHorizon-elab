...
@register.add_config_manager("1_heat_small_beaker_on_heat_device_and_press")
class Task1HeatSmallBeakerOnHeatDeviceAndPressConfigManager(BenchTaskConfigManager):
...
@register.add_task("1_heat_small_beaker_on_heat_device_and_press")
class Task1HeatSmallBeakerOnHeatDeviceAndPressTask(PrimitiveTask):
