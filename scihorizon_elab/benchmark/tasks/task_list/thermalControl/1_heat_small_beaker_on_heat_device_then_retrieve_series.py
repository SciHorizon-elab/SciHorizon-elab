...
@register.add_config_manager("1_heat_small_beaker_on_heat_device_then_retrieve")
class Task1HeatSmallBeakerOnHeatDeviceThenRetrieveConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Place the <small_beaker_0> containing <CuSO4 solution_0> on the <heat_device_0>."]
...
@register.add_task("1_heat_small_beaker_on_heat_device_then_retrieve")
class Task1HeatSmallBeakerOnHeatDeviceThenRetrieveTask(PrimitiveTask):
