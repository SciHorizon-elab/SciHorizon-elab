...
@register.add_config_manager("1_heat_small_beaker_then_flask_on_heat_device")
class Task1HeatSmallBeakerThenFlaskOnHeatDeviceConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(-0.0830, 0.1710), random.uniform(0.0480, 0.2280), 0.8],
        )
...
@register.add_task("1_heat_small_beaker_then_flask_on_heat_device")
class Task1HeatSmallBeakerThenFlaskOnHeatDeviceTask(PrimitiveTask):
