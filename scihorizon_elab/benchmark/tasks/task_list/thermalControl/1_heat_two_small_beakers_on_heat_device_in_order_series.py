...
@register.add_config_manager("1_heat_two_small_beakers_on_heat_device_in_order")
class Task1HeatTwoSmallBeakersOnHeatDeviceInOrderConfigManager(BenchTaskConfigManager):
...
@register.add_task("1_heat_two_small_beakers_on_heat_device_in_order")
class Task1HeatTwoSmallBeakersOnHeatDeviceInOrderTask(PrimitiveTask):
