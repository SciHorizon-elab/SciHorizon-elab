...
@register.add_config_manager("2_incubate_flask_in_water_bath")
class Task2IncubateFlaskInWaterBathConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Wait until a human adds <water_0> to the <water_bath_0>. Place the <flask_0> containing <CuSO4 solution_0> in the <water_bath_0>. Wait_for 3 seconds."]
...
@register.add_task("2_incubate_flask_in_water_bath")
class Task2IncubateFlaskInWaterBathTask(PrimitiveTask):
