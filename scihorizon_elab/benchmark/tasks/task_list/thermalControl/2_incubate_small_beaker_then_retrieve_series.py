...
@register.add_config_manager("2_incubate_small_beaker_then_retrieve")
class Task2IncubateSmallBeakerThenRetrieveConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Wait until a human adds <water_0> to the <water_bath_0>. Place the <small_beaker_0> containing <KMnO4 solution_0> in the <water_bath_0>. Wait for 3 seconds. Pick the <small_beaker_0> out. Then drop the <small_beaker_0>."]
...
@register.add_task("2_incubate_small_beaker_then_retrieve")
class Task2IncubateSmallBeakerThenRetrieveTask(PrimitiveTask):
