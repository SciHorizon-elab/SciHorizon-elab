...
@register.add_config_manager("2_incubate_two_small_beakers_in_water_bath")
class Task2IncubateTwoSmallBeakersInWaterBathConfigManager(BenchTaskConfigManager):
    ...
    def load_objects(self, target_entity):
        ...
        obj_config = dict(
            ...
            position=[random.uniform(0.1455, 0.2165), random.uniform(-0.1800, -0.1120), 0.8],
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Wait until a human adds <water_0> to the <water_bath_0>. Place the <small_beaker_0> containing <FeCl2 solution_0> in the <water_bath_0>. Wait for 3 seconds. Pick the <small_beaker_0> out. Then drop the <small_beaker_0>. Then place the <small_beaker_1> containing <KMnO4 solution_0> in the <water_bath_0>. Wait for 3 seconds."]
    ...
    def get_condition_config(self, target_entity, **kwargs):
        conditions_config = [
            ...
            dict(contain=dict(container='water_bath_0', entities=['small_beaker_1'])),
        ]
        self.config["task"]["conditions"] = conditions_config


@register.add_task("2_incubate_two_small_beakers_in_water_bath")
class Task2IncubateTwoSmallBeakersInWaterBathTask(PrimitiveTask):
