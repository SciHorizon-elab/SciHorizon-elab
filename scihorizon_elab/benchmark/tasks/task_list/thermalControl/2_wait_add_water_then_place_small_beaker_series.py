...
@register.add_config_manager("2_wait_add_water_then_place_small_beaker")
class Task2WaitAddWaterThenPlaceSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Wait until a human adds <water_0> to the <water_bath_0>. Place the <small_beaker_0> containing <CuSO4 solution_0> in the <water_bath_0>."]
...
@register.add_task("2_wait_add_water_then_place_small_beaker")
class Task2WaitAddWaterThenPlaceSmallBeakerTask(PrimitiveTask):
