...
@register.add_config_manager("3_insert_thermometer_into_small_beaker")
class Task3InsertThermometerIntoSmallBeakerConfigManager(BenchTaskConfigManager):
    ...
    def get_instruction(self, target_entity, **kwargs):
        self.config["task"]["instructions"] = ["Insert the <thermometer_0> into the <small_beaker_0> containing <CuSO4 solution_0>."]
...
@register.add_task("3_insert_thermometer_into_small_beaker")
class Task3InsertThermometerIntoSmallBeakerTask(PrimitiveTask):
