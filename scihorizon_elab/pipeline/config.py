...
class AgentConfig:
    ...
    # API Key (已配置)
    # ANTHROPIC_API_KEY: str = "sk-7KXZc0k9wZ8pCWBH91E2Ac888555424d9f083c92A8A3660c"
    ANTHROPIC_API_KEY: str = "sk-wAGGo7bNa3W9Q8VygNYt9a7mZBVc4vjUvUJbSHtIYaisklzD"
...
# 使用示例:
# from scihorizon_elab.pipeline.config import AgentConfig
