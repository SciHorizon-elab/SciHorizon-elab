...
def _classify_asset_type(raw_type: str, cache: Dict, llm: Optional) -> tuple:
    ...
    if llm is None:
        ...
        simple_spec = _simple_spec_match(raw_type)
        # 二次 cache 查询：用 simple_spec 作为 key 查 cache
        # 例如 raw_type="Pick up beaker" → simple_spec="beaker" → cache["beaker"]="small_beaker"
        cached_refined = get_cached(simple_spec, cache)
        if cached_refined:
            logger.info(f"[Normalizer] 二次 cache 命中: {simple_spec} → {cached_refined['spec']}")
            return cached_refined["spec"], cached_refined["source_type"], cached_refined["is_physical"]
        return simple_spec, "local", True
...
def normalizer_node(state: Dict) -> Dict:
    ...
    # ============================================================
    # 预填常用资产别名映射（避免 Analyzer 自由推断导致资产找不到）
    # 表格自然语言词 → name2class_xml 标准 key
    # ============================================================
    _PREFILLED_ALIASES: Dict[str, Dict] = {
        # 搅拌工具
        "glass rod":              {"spec": "glass_stirring_rod",  "source_type": "local", "is_physical": True},
        "the glass rod":          {"spec": "glass_stirring_rod",  "source_type": "local", "is_physical": True},
        "stirring rod":           {"spec": "glass_stirring_rod",  "source_type": "local", "is_physical": True},
        "glass stirring rod":     {"spec": "glass_stirring_rod",  "source_type": "local", "is_physical": True},
        "glass_rod":              {"spec": "glass_stirring_rod",  "source_type": "local", "is_physical": True},
        "glass_stirring_rod":     {"spec": "glass_stirring_rod",  "source_type": "local", "is_physical": True},
        "magnetic stir plate":    {"spec": "magnetic_stir_plate", "source_type": "local", "is_physical": True},
        "stir plate":             {"spec": "magnetic_stir_plate", "source_type": "local", "is_physical": True},
        "magnetic stirrer":       {"spec": "magnetic_stir_plate", "source_type": "local", "is_physical": True},
        # 量筒
        "medium cylinder":        {"spec": "cylinder_mid",   "source_type": "local", "is_physical": True},
        "the medium cylinder":    {"spec": "cylinder_mid",   "source_type": "local", "is_physical": True},
        "graduated cylinder":     {"spec": "cylinder_mid",   "source_type": "local", "is_physical": True},
        "cylinder":               {"spec": "cylinder_mid",   "source_type": "local", "is_physical": True},
        "the cylinder":           {"spec": "cylinder_mid",   "source_type": "local", "is_physical": True},
        "small cylinder":         {"spec": "cylinder_small", "source_type": "local", "is_physical": True},
        "large cylinder":         {"spec": "cylinder_large", "source_type": "local", "is_physical": True},
        "big cylinder":           {"spec": "cylinder_big",   "source_type": "local", "is_physical": True},
        # 试管/试管架
        "tube rack":              {"spec": "chemistry_tube_stand", "source_type": "local", "is_physical": True},
        "tube stand":             {"spec": "chemistry_tube_stand", "source_type": "local", "is_physical": True},
        "the tube rack":          {"spec": "chemistry_tube_stand", "source_type": "local", "is_physical": True},
        "the tube stand":         {"spec": "chemistry_tube_stand", "source_type": "local", "is_physical": True},
        # 烧瓶/锥形瓶
        "conical flask":          {"spec": "flask", "source_type": "local", "is_physical": True},
        "round-bottom flask":     {"spec": "florence_flask", "source_type": "local", "is_physical": True},
        "florence flask":         {"spec": "florence_flask", "source_type": "local", "is_physical": True},
        "small flask":            {"spec": "flask", "source_type": "local", "is_physical": True},
        # 培养皿
        "petri dish":             {"spec": "petri_dish", "source_type": "local", "is_physical": True},
        # 温度计
        "thermometer":            {"spec": "thermometer", "source_type": "local", "is_physical": True},
        "the thermometer":        {"spec": "thermometer", "source_type": "local", "is_physical": True},
        # 大烧杯
        "large beaker":           {"spec": "large_beaker", "source_type": "local", "is_physical": True},
        "the large beaker":       {"spec": "large_beaker", "source_type": "local", "is_physical": True},
        # 加热/称量
        "hot plate":              {"spec": "hot_plate", "source_type": "local", "is_physical": True},
        "electronic scale":       {"spec": "electronic_scale", "source_type": "local", "is_physical": True},
        "scale":                  {"spec": "electronic_scale", "source_type": "local", "is_physical": True},
        # 水浴
        "water bath":             {"spec": "water_bath", "source_type": "local", "is_physical": True},
        "the water bath":         {"spec": "water_bath", "source_type": "local", "is_physical": True},
        "water_bath":             {"spec": "water_bath", "source_type": "local", "is_physical": True},
        # 人工加水事件（非物理概念，无需 3D 模型）
        "human water addition":   {"spec": "human_water_addition", "source_type": "local", "is_physical": False},
        "water addition":         {"spec": "human_water_addition", "source_type": "local", "is_physical": False},
        "human_water_addition":   {"spec": "human_water_addition", "source_type": "local", "is_physical": False},
        # 隔热垫（表格用 insulating mat，本地资产是 square_mat）
        "insulating mat":         {"spec": "square_mat", "source_type": "local", "is_physical": True},
        "the insulating mat":     {"spec": "square_mat", "source_type": "local", "is_physical": True},
        "insulating_mat":         {"spec": "square_mat", "source_type": "local", "is_physical": True},
        "square mat":             {"spec": "square_mat", "source_type": "local", "is_physical": True},
        "the square mat":         {"spec": "square_mat", "source_type": "local", "is_physical": True},
        "square_mat":             {"spec": "square_mat", "source_type": "local", "is_physical": True},
        # 溶液补全
        "KMnO4 solution":         {"spec": "KMnO4 solution", "source_type": "local", "is_physical": False},
        "CuSO4 solution":         {"spec": "CuSO4 solution", "source_type": "local", "is_physical": False},
        "FeCl2 solution":         {"spec": "FeCl2 solution", "source_type": "local", "is_physical": False},
        "the KMnO4 solution":     {"spec": "KMnO4 solution", "source_type": "local", "is_physical": False},
        "the CuSO4 solution":     {"spec": "CuSO4 solution", "source_type": "local", "is_physical": False},
        "the FeCl2 solution":     {"spec": "FeCl2 solution", "source_type": "local", "is_physical": False},
    }
    for alias, mapping in _PREFILLED_ALIASES.items():
        # 强制覆盖已有条目（包括错误 objaverse 映射）
        cache[alias] = mapping
    save_cache(cache)
