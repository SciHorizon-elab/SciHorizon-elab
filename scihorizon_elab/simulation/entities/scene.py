...
from scihorizon_elab.utils.utils import euler_to_quaternion, quaternion_multiply, rotate_point_by_quaternion
...
class Scene(composer.Entity):
    def __init__(self, use_default_scene=True, *args, **kwargs):
        self.scene_asset_root = os.path.join(os.getenv("SCIHORIZON_ELAB_ROOT"), "simulation", "assets/scenes")
    ...
    def _build(self, *args, **kwargs):
        ...
        with open(os.path.join(os.getenv("SCIHORIZON_ELAB_ROOT"), "simulation/configs/scene_config.json"), "r") as f:
