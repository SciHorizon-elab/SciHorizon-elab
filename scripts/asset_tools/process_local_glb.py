...
_PROJECT_ROOT = _SCRIPTS_DIR.parent.parent  # tests -> pipeline -> scihorizon_elab
...
class LocalGLBPipeline:
    ...
    def __init__(
        ...
        if output_dir is None:
            output_dir = str(_PROJECT_ROOT / "scihorizon_elab" / "assets" / "review")
...
示例:
  ...
  python process_local_glb.py --input_dir /path/to/glbs --keyword lab_equip \\
    ...
    parser.add_argument('--output_dir', type=str, default=None,
                        help='输出根目录（默认: scihorizon_elab/scihorizon_elab/assets/review）')
