...
class LeRobotVLABenchDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        # NOTE: RepackTransform keys are the NEW (dest) names; values are source paths in the dataset.
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform(
                    {
        ...
        # rotvec + RLDS wrap: target/state 绝对 rotvec 在 180° 边界仍会 ±2π 翻转,
        # RLDSDeltaActions 在 actions[..., 3:6] 上做 (d+π)%(2π)-π wrap,
        # 真实单步 delta <0.3 rad 时精确恢复真实旋转增量。
        delta_action_mask = _transforms.make_bool_mask(6, -1)
        data_transforms = data_transforms.push(
...
_CONFIGS = [
    ...
    # Step10 LIBERO 单任务验证 — libero_spatial task 0 (45 episodes / 4487 帧)
    # 配方: pi05_base + LoRA + 224输入 + GB32 + 无 EMA (对齐官方 LoRA 惯例)
    #       + 1k warmup + 2.5e-5 cosine 衰减 (对齐官方 pi0_libero_low_mem_finetune)
    # 步数: 10k = 71 epochs, 刻意深入过拟合区以实测拐点 (表格证据: 安全区 25-50 ep, 75 ep 崩溃)
    # 保存: 每 1500 步 ≈ 10 epochs 一个 checkpoint
    TrainConfig(
        name="pi05_ft_libero_spatial_t0",
        model=pi0_config.Pi0Config(
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="libero_spatial_t0",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=False,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/workspace/pi05_base/params"
        ),
        freeze_filter=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
        ...
        assets_base_dir="/ssd/qinmaokai/workspace/SciHorizon-ELAB/.cache/openpi/assets",
        lr_schedule=_optimizer.CosineDecaySchedule(
            warmup_steps=1_000,
            peak_lr=2.5e-5,
            decay_steps=10_000,
    ...
    # Local fine-tune of pi0.5 on user-provided place_beaker_pres_heat_device data.
    # Continues from the locally-downloaded pi05-primitive-10task checkpoint.
    TrainConfig(
        name="pi05_ft_place_beaker",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_pres_heat_device",
    ...
    # v3: fine-tune on 400 trajectories (200 original + 200 new), 30k steps
    TrainConfig(
        name="pi05_ft_place_beaker_v3",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_pres_heat_device_v3",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
    ...
    # v4: use last 200 trajectories from place_beaker_pres_heat_device (correct instruction)
    TrainConfig(
        name="pi05_ft_place_beaker_v4",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_pres_heat_device_v3_200ep",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# place_flask_on_the_mat
    TrainConfig(
        name="pi05_ft_place_flask_on_the_mat",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_flask_on_the_mat_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# insert_stirring_rod
    TrainConfig(
        name="pi05_ft_insert_stirring_rod",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="insert_stirring_rod_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# place_beaker_pres_heat_device
    TrainConfig(
        name="pi05_ft_place_beaker_pres_heat_device",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_pres_heat_device_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# pick_tube_shake_tube
    TrainConfig(
        name="pi05_ft_pick_tube_shake_tube",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="pick_tube_shake_tube_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# pour_object_stir_large_beaker
    TrainConfig(
        name="pi05_ft_pour_object_stir_large_beaker",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="pour_object_stir_large_beaker_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# pick_tube_lift_tube
    TrainConfig(
        name="pi05_ft_pick_tube_lift_tube",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="pick_tube_lift_tube_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
...
# place_beaker_3
    TrainConfig(
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_3_series_v2",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
    ...
    # place_beaker_3 v3: euler unwrap 修复后的重训配置
    # - 数据: place_beaker_3_series_v3（unwrap 后，105 episodes）
    # - 基座: 官方 pi05_base（替换自训 primitive-10task，避免污染传导）
    # - lr_schedule: 显式设置（修复默认 30k 衰减 + 100k 步的 LR 失配）
    TrainConfig(
        name="pi05_ft_place_beaker_3_v3",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_3_series_v3",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/workspace/pi05_base/params"
    ...
    # place_beaker_3 v4: 224 分辨率 + 全面对齐官方 pi05_libero 训练配置
    # - 数据: place_beaker_3_series_v4_224（unwrap + resize 224，对齐 PaliGemma 预训练分辨率）
    # - 基座: 官方 pi05_base + LoRA
    # - EMA 0.999（对齐官方；v3 时 LoRA 惯例关闭，本版开启以对齐官方路径）
    # - global batch 256（64/卡 × 4 卡，对齐官方 256）
    # - lr_schedule 与官方 pi05_libero 一致（warmup 1k 简化自官方 10k，LoRA 场景）
    TrainConfig(
        name="pi05_ft_place_beaker_3_v4",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_3_series_v4_224",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/workspace/pi05_base/params"
        ...
        assets_base_dir="/ssd/qinmaokai/workspace/SciHorizon-ELAB/.cache/openpi/assets",
        checkpoint_base_dir="/ssd/qinmaokai/workspace/SciHorizon-ELAB/third_party/openpi/checkpoints",
        lr_schedule=_optimizer.CosineDecaySchedule(
            warmup_steps=1_000,
            peak_lr=5e-5,
            decay_steps=1_000_000,
    ...
    # place_beaker_3 v5: 路线 C —— v3 配置 + 224（单变量：只改分辨率）
    # 其他全继承 v3（unwrap + pi05_base + LoRA + b128 + 无 EMA + 1k warmup + 5e-5 恒定）
    # 30k 步（与 v4 同尺度，能直接对比"b128 30k" vs "b128 20k"）
    # 目的：隔离"224 是否有视觉收益"
    TrainConfig(
        name="pi05_ft_place_beaker_3_v5",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_3_series_v5_224",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/workspace/pi05_base/params"
    ...
    # place_beaker_on_the_mat: pick beaker and place on mat (simpler task)
    TrainConfig(
        name="pi05_ft_place_beaker_on_the_mat",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="place_beaker_on_the_mat_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
    ...
    # pick_cylinder_mid_pour_object_series
    TrainConfig(
        name="pi05_ft_pick_cylinder",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotVLABenchDataConfig(
            repo_id="pick_cylinder_mid_pour_object_series",
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/ssd/qinmaokai/.cache/openpi/vlabench_checkpoints/pi05-primitive-10task/params"
